...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Dongcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"dongcointools.com", "dnsseed.dongcointools.com"},
    {"dongcoinpool.org", "dnsseed.dongcoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"dongcointools.com", "testnet-seed.dongcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Dongcoin is probably already running."), addrBind.ToString().c_str());
        else
